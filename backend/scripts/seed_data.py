"""
Seed mock data for local development (no external dependencies).
"""
import os
import sys
...
# Demo team members
MEMBERS = [
    {"name": "Alex Chen", "avatar_initials": "AC", "timezone": "America/Los_Angeles", "role": "member"},
    {"name": "Jordan Kim", "avatar_initials": "JK", "timezone": "America/New_York", "role": "member"},
    {"name": "Sam Rivera", "avatar_initials": "SR", "timezone": "America/Chicago", "role": "member"},
    {"name": "Taylor Moore", "avatar_initials": "TM", "timezone": "America/Denver", "role": "member"},
    {"name": "Casey Brooks", "avatar_initials": "CB", "timezone": "America/Toronto", "role": "member"},
]
...
def main():
    ...
    # Create a demo team with a separate manager
    team_name = "Care Team Alpha"
    # Create a separate manager user
    manager_data = {
        "name": "Demo Manager",
        "avatar_initials": "DM",
    ...
    print("\n✅ Seeding complete!")
    print("\nDemo story:")
    print("  - Alex Chen: Trending to HIGH risk (~85), 8 consecutive overloaded days")
    print("  - Jordan Kim: MEDIUM risk (~72), recently crossed threshold") 
    print("  - Sam Rivera: LOW risk (~15), has capacity for rebalancing")
